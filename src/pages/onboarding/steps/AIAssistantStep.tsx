    ...
    <div className="max-w-6xl w-full mx-auto flex flex-col gap-6 justify-center items-center flex-1 select-none pt-4 pb-16 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <img
          ...
          className="mx-auto max-w-xl w-full object-cover border-2 border-transparent dark:border-input rounded-md select-none motion-safe:animate-fade-in delay-200 order-2 md:order-1"
        />
