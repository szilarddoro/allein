...
export function DraggableCard({
  ...
  return (
    <li
      ...
      tabIndex={-1}
      className={cn(
        'rounded-md outline-none relative motion-safe:transition-all before:absolute before:bg-transparent motion-safe:before:transition-colors before:rounded-md before:z-[100] before:inset-0 before:pointer-events-none focus-visible:ring-[3px] focus-visible:ring-ring/50',
        isDragging &&
