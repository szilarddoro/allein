...
export function Sidebar({
  ...
  async function handleCreateFile(folderPath?: string) {
    try {
      ...
      navigate({
        pathname: '/editor',
        search: `?file=${encodeURIComponent(path)}&${FOCUS_NAME_INPUT_SEARCH_PARAM}=true`,
      })
    } catch {
  ...
  return (
    <div className="z-[100] relative w-full h-full flex flex-col bg-card dark:bg-zinc-900/50 border border-border rounded-[12px] overflow-hidden">
